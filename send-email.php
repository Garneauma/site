<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $subject = "New email from Garneauma.com: " . trim($_POST["contactSubject"]);
        $message = trim($_POST["contactBody"]);
        ...
        $email_headers = "From: $name ($email) <info@garneauma.com>";
